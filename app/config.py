...
# Полупрозрачность и цветной заголовок через pywinstyles (Windows 11).
# Если эффекты мешают или тормозят на слабом ПК — поставить False.
ENABLE_WINDOW_EFFECTS = True
# Прозрачность окна: 1.0 — непрозрачно, 0.98 — едва заметный «материал»
WINDOW_ALPHA = 0.98
